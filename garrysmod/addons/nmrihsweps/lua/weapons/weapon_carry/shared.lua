...
local allow_rag  = CreateConVar("carry_ragdoll_carrying", "1")
--local rag_force = CreateConVar("carry_ragdoll_carrying_force", "9000")
local prop_force = CreateConVar("carry_prop_carrying_force", "60000")
local no_throw   = CreateConVar("carry_no_prop_throwing", "0")
local pin_rag    = CreateConVar("carry_ragdoll_pinning", "1")
local pin_rag_inno = CreateConVar("carry_ragdoll_pinning_innocents", "0")
...
local allow_wep = CreateConVar("carry_weapon_carrying", "0")
local wep_range = CreateConVar("carry_weapon_carrying_range", "50")
...
function SWEP:PinRagdoll()
   ...
   if (not pin_rag_inno:GetBool()) then return end
